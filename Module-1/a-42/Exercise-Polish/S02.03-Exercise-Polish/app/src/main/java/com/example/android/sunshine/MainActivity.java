...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView nerrormessagetextview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nerrormessagetextview = (TextView) findViewById(R.id.error_error);
        // TODO (17) Find the ProgressBar using findViewById
        progressBarr = (ProgressBar) findViewById(R.id.progress_bar);
